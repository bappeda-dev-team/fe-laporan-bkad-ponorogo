...
import { LoadingButtonClip2 } from "../global/Loading";
...
export const ButtonSky: React.FC<button> = ({children, type, className, halaman_url, onClick, disabled}) => {
    ...
    return(
        <button
            className={`px-3 flex justify-center items-center bg-gradient-to-r cursor-pointer from-[#08C2FF] to-[#006BFF] hover:from-[#0584AD] hover:to-[#014CB2] text-white rounded-lg ${className}`}
...
export const ButtonSkyBorder: React.FC<button> = ({children, type, className, halaman_url, onClick, disabled}) => {
    ...
    return(
        <button
            className={`px-3 flex justify-center items-center bg-gradient-to-r cursor-pointer border-2 border-[#3072D6] hover:bg-[#3072D6] text-[#3072D6] hover:text-white rounded-lg ${className}`}
            disabled={disabled || Loading}
            type={type}
            onClick={onClick || pindahHalaman}
        >
...
export const ButtonGreen: React.FC<button> = ({children, type, className, halaman_url, onClick, disabled}) => {
    ...
    return(
        ...
        type={type}
        onClick={onClick || pindahHalaman}
            className={`px-3 flex justify-center items-center bg-gradient-to-r cursor-pointer from-[#1CE978] to-[#11B935] hover:from-[#1EB281] hover:to-[#0D7E5C] text-white rounded-lg ${className}`}
        >
            {Loading ? 
                (
                <>
...
export const ButtonGreenBorder: React.FC<button> = ({children, type, className, halaman_url, onClick, disabled}) => {
    ...
    return(
        <button
            className={`px-3 flex justify-center items-center bg-gradient-to-r cursor-pointer border-2 border-[#00A607] hover:bg-[#00A607] text-[#00A607] hover:text-white rounded-lg ${className}`}
            disabled={disabled || Loading}
            type={type}
            onClick={onClick || pindahHalaman}
        >
...
export const ButtonRed: React.FC<button> = ({children, type, className, halaman_url, onClick, disabled}) => {
    ...
    return(
        <button
            className={`px-3 flex justify-center items-center bg-gradient-to-r cursor-pointer from-[#DA415B] to-[#BC163C] hover:from-[#B7384D] hover:to-[#951230] text-white rounded-lg ${className}`}
            disabled={disabled || Loading}
            type={type}
            onClick={onClick || pindahHalaman}
        >
...
export const ButtonRedBorder: React.FC<button> = ({children, type, className, halaman_url, onClick, disabled}) => {
    ...
    return(
        <button
            className={`px-3 flex justify-center items-center bg-gradient-to-r cursor-pointer border-2 border-[#D20606] text-[#D20606] hover:bg-[#D20606] hover:text-white rounded-lg ${className}`}
            disabled={disabled || Loading}
            type={type}
            onClick={onClick || pindahHalaman}
        >
