...
import { ButtonRedBorder, ButtonSkyBorder, ButtonBlackBorder, ButtonGreenBorder } from "@/components/button/button";
import { TbX, TbTrash, TbUpload, TbPencil, TbCirclePlus, TbPrinter, TbCircleFilled } from "react-icons/tb";
...
interface TableKonker {
    data: TimGetResponse;
}

export const Table: React.FC<TableKonker> = ({ data }) => {
    ...
    const url = useMemo(() => {
        ...
        return `/api-laporan/timkerja/${data.kode_tim}/program_unggulan?tahun=${tahun}&bulan=${bulan}`;
    }, [isReady, tahun, bulan]);
